...
import com.shucai.concurrent.jmh.generated.JMHExample07_jmhType;
import com.shucai.concurrent.jmh.generated.JMHExample07_Test_jmhType;
public final class JMHExample07_test_jmhTest {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JMHExample07_jmhType l_jmhexample070_0 = _jmh_tryInit_f_jmhexample070_0(control);
            JMHExample07_Test_jmhType l_test1_G = _jmh_tryInit_f_test1_G(control);
            ...
            while (control.warmupShouldWait) {
                l_jmhexample070_0.test(l_test1_G);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            test_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_test1_G, l_jmhexample070_0);
    ...
    public static void test_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, JMHExample07_Test_jmhType l_test1_G, JMHExample07_jmhType l_jmhexample070_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            test_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_test1_G, l_jmhexample070_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_test1_G, l_jmhexample070_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void test_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHExample07_Test_jmhType l_test1_G, JMHExample07_jmhType l_jmhexample070_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            test_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_test1_G, l_jmhexample070_0);
            control.preTearDown();
    ...
    public static void test_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, JMHExample07_Test_jmhType l_test1_G, JMHExample07_jmhType l_jmhexample070_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile JMHExample07_Test_jmhType f_test1_G;
    
    JMHExample07_Test_jmhType _jmh_tryInit_f_test1_G(InfraControl control) throws Throwable {
        JMHExample07_Test_jmhType val = f_test1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = new JMHExample07_Test_jmhType();
            val.readyTrial = true;
            f_test1_G = val;
            } catch (Throwable t) {
    ...
    JMHExample07_jmhType f_jmhexample070_0;
    
    JMHExample07_jmhType _jmh_tryInit_f_jmhexample070_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        JMHExample07_jmhType val = f_jmhexample070_0;
        if (val == null) {
            val = new JMHExample07_jmhType();
            f_jmhexample070_0 = val;
        }
        return val;
    }
